...
import { STATUS_COLORS, StatusColor, getColorByHex } from "@shared/constants/status-colors";
...
@Component({
    ...
    imports: [ReactiveFormsModule, LucideAngularModule, ButtonDirective, FormError],
